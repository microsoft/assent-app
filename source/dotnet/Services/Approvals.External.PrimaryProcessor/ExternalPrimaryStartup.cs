...
using Microsoft.Approvals.PrimaryProcessor.BL;

[assembly: FunctionsStartup(typeof(ExternalPrimaryStartup))]

namespace PrimaryAzFunction;

public class ExternalPrimaryStartup : FunctionsStartup
{
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        builder.Services.AddScoped<IApprovalsTopicReceiver, ExternalGenericReceiver>();

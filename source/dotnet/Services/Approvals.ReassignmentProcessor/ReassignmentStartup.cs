...
using Approvals.ReassignmentProcessor.BL;
...
[assembly: FunctionsStartup(typeof(ReassignmentStartup))]

namespace ReassignmentAzFunction;

public class ReassignmentStartup : FunctionsStartup
{
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        builder.Services.AddScoped<IApprovalsQueueReceiver, ReassignmentReceiver>();

        builder.Services.AddScoped<IReassignmentProcessor, ReassignmentProcessor>();
        builder.Services.AddSingleton<IServiceBusHelper, ServiceBusHelper>(x => new ServiceBusHelper(serviceBusSenders));
    }

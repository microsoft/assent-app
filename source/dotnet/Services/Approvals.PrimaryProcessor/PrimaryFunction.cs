...
public class PrimaryFunction
{
    ...
    public PrimaryFunction(IApprovalTenantInfoHelper approvalTenantInfoHelper, IApprovalsTopicReceiver genericReceiver, ILogProvider logger)
    {
    ...
    public async Task Run(
        [ServiceBusTrigger("%TopicNameMain%", "%SubscriptionName%", Connection = "ServiceBusEndpoint")] ServiceBusReceivedMessage message,
        ServiceBusMessageActions messageActions)
    {
        ...
        catch (Exception ex)
        {
            ...
            else
            {
                ...
                await messageActions.DeadLetterMessageAsync(message, deadLetterReason: "ProcessingError", deadLetterErrorDescription: truncatedDescription);
            }
        }
    }
}
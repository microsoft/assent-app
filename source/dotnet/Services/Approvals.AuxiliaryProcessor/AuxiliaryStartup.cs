...
using Approvals.AuxiliaryProcessor.BL;
using Approvals.AuxiliaryProcessor.BL.Interface;
using AuxiliaryAzFunction;
...
[assembly: FunctionsStartup(typeof(AuxiliaryStartup))]

namespace AuxiliaryAzFunction;

public class AuxiliaryStartup : FunctionsStartup
{
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        builder.Services.AddScoped<IAuxiliaryProcessor, AuxiliaryProcessor>();

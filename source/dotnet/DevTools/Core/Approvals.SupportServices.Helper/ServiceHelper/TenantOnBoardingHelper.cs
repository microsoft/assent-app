...
namespace Microsoft.CFS.Approvals.SupportServices.Helper.ServiceHelper
{
    ...
    public class TenantOnBoardingHelper : ITenantOnBoardingHelper
    {
        ...
        public TenantOnBoardingHelper(Func<string, string, ITableHelper> azureTableStorageHelper,
            ...
            Func<ConfigurationHelper, IActionContextAccessor, string, string, IBlobStorageHelper> blobStorageHelper,
            IHttpHelper httpHelper)
        {
            ...
            _blobStorageHelper = blobStorageHelper(configurationHelper, actionContextAccessor,
                configurationHelper.appSettings[_environment].StorageAccountName, configurationHelper.appSettings[_environment].StorageAccountKey);
        ...
        private async Task SubmitRequest(JObject applicationDetail, IFormFileCollection files)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                throw new Exception("Error to create the application.");
        }
        ...
        private async Task ApproveRequest(JObject applicationDetail, IFormFileCollection files)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                throw new Exception("Error to approve the application.");
        }

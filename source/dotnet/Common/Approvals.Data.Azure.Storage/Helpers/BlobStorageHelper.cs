...
public class BlobStorageHelper : IBlobStorageHelper
{
    ...
    public BlobStorageHelper(string accountName, TokenCredential tokenCredential)
    {
        var serviceUri = new Uri($"https://{accountName}.blob.core.windows.net");
        _blobServiceClient = new BlobServiceClient(serviceUri, tokenCredential);
    }
    ...
    /// <param name="storageAccountKey">Storage Account Key</param>
    /// <returns>Task</returns>
    public async Task<string> UploadStreamData(Stream stream, string containerName, string blobName, string storageAccountName = "", string storageAccountKey = "")
    {

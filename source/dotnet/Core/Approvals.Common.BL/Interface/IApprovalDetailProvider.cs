...
namespace Microsoft.CFS.Approvals.Common.DL.Interface
{
    ...
    public interface IApprovalDetailProvider
    {
        ...
        /// <param name="tenantId"></param>
        /// <param name="telemetry"></param>
        Task RemoveAttachmentFromBlob(List<Attachment> attachments, ApprovalIdentifier approvalIdentifier, string operationName, string clientDevice, string tenantId, ApprovalsTelemetry telemetry);

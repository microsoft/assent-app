        ...
        public async Task<JObject> ManagePost(string documentTypeId, string payload)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(payload))
                {
                    ...
                    {
                        throw new Exception("Payload processing result is null or empty. Payload cannot be processed. Please contact Approvals Service Engineering Team.");
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Payload processing failed. Please contact Approvals Engineering Team. Activity Id: " + activityId.ToString());
            }

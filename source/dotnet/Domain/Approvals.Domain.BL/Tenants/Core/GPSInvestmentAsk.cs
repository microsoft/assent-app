...
/// <summary>
/// Class OCPInvestmentAsk
/// </summary>
/// <seealso cref="GenericTenant" />
public class GPSInvestmentAsk : GenericTenant
{
    #region CONSTRUCTOR

    public GPSInvestmentAsk(
    ...
    protected override async Task<string> GetDetailURL(string urlFormat, ApprovalIdentifier approvalIdentifier, int page, string xcv = "", string tcv = "", string businessProcessName = "", string docTypeId = "")
    {
        ...
        return string.Format(urlFormat, actualApprovalIdentifier.DocumentNumber);
    }
    ...
    {
        return string.Format(documentSummaryUrl, approvalRequest.ApprovalIdentifier.DocumentNumber);
    }
}
...
export enum TrackingEventId {
    ...
    CopilotSuccess,
    CopilotFailure,
    AttachmentCopilotPostiveFeedback,
    AttachmentCopilotNegativeFeedback,
    SearchInitiated,
    DeepSearchFailure,
    DeepSearchSuccess,
    SupportBotLaunchSuccess,
    SupportBotLaunchFailure,
    QuickTourSuccess,
    QuickTourFailure,
    UpdateQuickToursSuccess,
    UpdateQuickToursFailure,
    PostFeedbackSuccess,
    PostFeedbackFailure,
    GetFlightingDataSuccess,
    GetFlightingDataFailure,
    SubscribeFlightingFeaturesSuccess,
    SubscribeFlightingFeaturesFailure,
    UnsubscribeFlightingFeaturesSuccess,
    UnsubscribeFlightingFeaturesFailure,
    SubmitFlightingFeatureFeedbackSuccess,
    SubmitFlightingFeatureFeedbackFailure,
    GetInsightsSuccess,
    GetInsightsFailure,
    TroubleshootButtonClick,
    SummarySectionExpand,
    SummarySectionCollapse,
    SubmitterViewPivotClick,
    SubmitterViewSummaryLoadSuccess,
    SubmitterViewSummaryLoadFailure,
    EditColumnsOpen,
    EditColumnsClose,
    ColumnToggle,
    ColumnResetDefaults,
    DeepSearchCitationClick,
    DeepSearchPreviewOpen,
    DeepSearchPreviewClose,
    DeepSearchPreviewError,
    SearchSuggestCacheHit,
    SearchSuggestCacheSkippedEmpty,
    SearchSuggestCacheRefetch,
    SearchSuggestDropdownShown,
    SearchSuggestTermSelected,
    SearchSuggestRequestSelected,
    SearchSuggestDismissed,
    DelegationExpiryWarningBannerShown,
    ApprovalsLabsTabOpen,
    SummaryDownloadSuccess,
    SummaryDownloadFailure,
}
